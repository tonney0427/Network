...
// NetProtocolDoc.cpp : CNetProtocolDoc 类的实现
//
...
// 缩略图的支持
void CNetProtocolDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CNetProtocolDoc::InitializeSearchContent()
{
	// 从文档数据设置搜索内容。
	// 内容部分应由“;”分隔
...
void CNetProtocolDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
